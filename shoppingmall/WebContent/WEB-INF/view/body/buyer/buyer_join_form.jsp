...
<div>
	...
	<form id="buyer_form"
		...
		<table>
			...
			<tr>
				<td><input type="password" id="password" name="password"
					...
					<div id="passwordErr" class="error" style="display: none">필수
						정보입니다.</div></td>
			</tr>
			<tr>
				<td><input type="password" id="passwordConfirm"
					...
					class="int">
					<div id="pconfirmErr" class="error" style="display: none">필수
						정보입니다.</div></td>
			</tr>
		</table>
		<br>
		<table>
			...
			<tr>
				<td><input type="text" id="phone" name="phone" maxlength="14"
					...
					<div id="phoneErr" class="error" style="display: none">필수
						정보입니다.</div></td>
			</tr>
		</table>
		<br>
		<table>
			<tr>
				<td><input type="text" id="email" name="email"
					...
					<div id="emailErr" class="error" style="display: none">필수
						정보입니다.</div></td>
			</tr>
			<tr>
		...
		<div id="joinErr" class="error" style="display: none">입력하신 정보를
			확인해주세요.</div>
		<table>
			<tr id="join">
